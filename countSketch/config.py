...
class config:
    ...
    def reinitializeParameters():
        ...
        config.p = 10000000  # Domain size
        config.n = 10000000  # Number of data samples, needed only for simulation
    ...
    dataPath = '/Users/abhradeep/locallyprivatehistogram/dataLoc/'
